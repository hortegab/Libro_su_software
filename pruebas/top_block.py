...
# Title: Top Block
# Generated: Wed Apr 10 05:15:27 2019
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.x = x = (1,0,1,0,1,1,0,1,0,0,0)
        ...
        self.interp_fir_filter_xxx_0 = filter.interp_fir_filter_fff(Nh, (h))
        self.interp_fir_filter_xxx_0.declare_sample_delay(0)
        self.blocks_vector_source_x_0 = blocks.vector_source_f(x, True, 1, [])
    ...
    def set_x(self, x):
        self.x = x
        self.blocks_vector_source_x_0.set_data(self.x, [])
