...
# Title: Lab Total
# Generated: Sun Mar  3 06:20:39 2019
##################################################
...
class Lab_total(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        for c in range(2, 3):
            self.controls_grid_layout_1.setColumnStretch(c, 1)
        self._tap1_range = Range(0, 1, 0.01, 1, 200)
        ...
        self.connect((self.digital_chunks_to_symbols_xx_0, 0), (self.qtgui_freq_sink_x_0_1, 1))
        ...
        self.connect((self.digital_pfb_clock_sync_xxx_0_0, 0), (self.qtgui_freq_sink_x_0_1, 0))
