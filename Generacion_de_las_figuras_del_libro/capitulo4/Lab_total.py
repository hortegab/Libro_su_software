...
# Description: Sps2, Rs2, Rb2  sido introducido con el fin de obtener una PSD sin tantos lobulos. Lo que hicimos es un sistema con dos salidas a diferentes velocidades
# Generated: Thu Mar  7 19:23:56 2019
##################################################
...
class Lab_total(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Lab_total")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab_total")
        ...
        self.MiconstellationObject3 = MiconstellationObject3 = digital.constellation_calcdist((const[3].points()), (), 4, 1).base()


        self.MiconstellationObject2 = MiconstellationObject2 = digital.constellation_calcdist((const[2].points()), (), 4, 1).base()


        self.MiconstellationObject1 = MiconstellationObject1 = digital.constellation_calcdist((const[1].points()), (), 4, 1).base()


        self.MiconstellationObject0 = MiconstellationObject0 = digital.constellation_calcdist((const[0].points()), (), 4, 1).base()
        ...
        self.top_grid_layout.addWidget(_run_stop_check_box)
        ...
        self.top_grid_layout.addWidget(self._qtgui_const_sink_x_0_1_win, 2, 0, 1, 1)
        for r in range(2, 3):
        ...
        self.b_symb_source_0_0_1 = b_symb_source(
            Constelacion=MiconstellationObject3.points(),
        )
        self.b_symb_source_0_0_0 = b_symb_source(
            Constelacion=MiconstellationObject2.points(),
        )
        self.b_symb_source_0_0 = b_symb_source(
        ...
        self.connect((self.analog_noise_source_x_0, 0), (self.blocks_add_xx_0_0_1, 1))
        self.connect((self.b_symb_source_0, 0), (self.blocks_add_xx_0, 0))
        self.connect((self.b_symb_source_0_0, 0), (self.blocks_add_xx_0_0, 0))
        self.connect((self.b_symb_source_0_0_0, 0), (self.blocks_add_xx_0_0_0, 0))
        self.connect((self.b_symb_source_0_0_1, 0), (self.blocks_add_xx_0_0_1, 0))
        self.connect((self.blocks_add_xx_0, 0), (self.qtgui_const_sink_x_0, 0))
        self.connect((self.blocks_add_xx_0_0, 0), (self.qtgui_const_sink_x_0_0, 0))
        self.connect((self.blocks_add_xx_0_0_0, 0), (self.qtgui_const_sink_x_0_1, 0))
        self.connect((self.blocks_add_xx_0_0_1, 0), (self.qtgui_const_sink_x_0_0_0, 0))
